...
<Seo
	title="Browse Quizzes - Quizify"
	description="Explore a wide variety of quizzes on Quizify. Find quizzes on any topic, test your knowledge, and challenge your friends."
	url={page.url.href}
	image="/logo.png"
	type="website"
	keywords="quizify, browse quizzes, all quizzes, quiz categories, trivia"
/>
